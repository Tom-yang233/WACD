import sys
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QVBoxLayout, QPushButton, QFileDialog, QLineEdit, QGridLayout
from PyQt5.QtGui import QPixmap
from PyQt5.QtCore import Qt
from pic_tx import tx_pic


class ImageInputApp(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def init_ui(self):
        self.setWindowTitle('Audio Image Transmit')
